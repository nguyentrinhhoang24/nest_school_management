    ...
    <div class="dashboard">
      <aside class="sidebar">
        ...
        <ul>
          ...
          <li>
            <a @click.prevent="navigateTo('feecollection')" href="#">Fee Collection</a>
            <ul>
          ...
          <li>
            <a @click.prevent="navigateTo('academy')" href="#">Academy</a>
            <ul>
          ...
          <li>
            <a @click.prevent="navigateTo('user')" href="#">User</a>
            <ul>
